      ...
      <section className='about-first'>
        <div className='inner-container'>
          ...
          <div className='about-text'>
            ...
            <p>I'm currently seeking full-time employment. Remote work is preferred, but I'm always open to local opportunities. If you're interested in discussing an opportunity, feel free to contact me!</p>
          </div>
        </div>
      </section>
    </div>
